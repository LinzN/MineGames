...
public class UpdateChecker {
    ...
    public void check(Player player, Plugin p) {
        ...
        try {
            ...
            URL url = new URL("http://mc-sg.org/plugins/MineGames/assets/updater/updatecheck.php");
            ...
            if (b) {
                ...
                player.sendMessage(ChatColor.DARK_RED + "[MineGames] Update Available!");
                ...
                player.sendMessage(ChatColor.DARK_BLUE + "--------------------------------------");
                MineGames.$("[Updates found!");

            } else {
                MineGames.$("[SG][info] No updates found!");
            }
        } catch (Exception e) {
            MineGames.$(Level.WARNING, "[MineGames] could not check for updates.");
        }
    }
}