...
public class LobbyManager {
    ...
    public void loadSign(int a) {
        try {
            MineGames.debug("sg-system.lobby.signs." + a + ".world");
    ...
    public void setLobbySignsFromSelection(Player pl, int a) {
        ...
        if ((sel.getMaximumPoint().getBlockX() - sel.getMinimumPoint().getBlockX()) != 0 && (sel.getMinimumPoint().getBlockZ() - sel.getMaximumPoint().getBlockZ() != 0)) {
